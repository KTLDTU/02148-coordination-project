...
public class Room {
    ...
    private void initializePlayerIds(Space roomSpace) throws InterruptedException {
    ...
    private void initializePlayerNames(Space roomSpace) throws InterruptedException {
